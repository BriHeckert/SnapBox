		      ...
		      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
		        <div class="card bg-dark text-white" style="border-radius: 1rem;">
		          <div class="card-body p-5 text-center" style="background-color:black; border-radius:15px">
		            ...
		            <form action="?command=RemoveActivityG" method="post">
		              <h2 style="font-size: 55px;font-family: sans-serif;"class="fw-bold mb-2 text-uppercase">Scrapbox</h2>
		              <p class="text-white-50 mb-5" style="color:white !important">Remove an Activity</p>
		              <p>Enter the name of the activity to remove</p>

					  <div class="form-outline form-white mb-4">
		                <input name="ActivityName" type="text" id="ActivityName" class="form-control form-control-lg" />
		              ...
		              <button class="btn btn-outline-light btn-lg px-5"type="submit" value="Submit">Remove from Group</button>
		            </form>
		            </div>
		          </div>
		        </div>
